...
import { responseTask, response } from 'src/app/Generics/GenericResponse';
import { taskListModel, createTaskModel, deletedTaskResponseData, createNewtask } from 'src/app/Models/task.model';
import { user, getAllTaskI, getAllEmployeeI } from 'src/app/Models/user.model';
...
export class MyTasksComponent {
  ...
  public editTask(task: any) {
    ...
    this.router.navigate([`/myTasks/${task.id}`]);
  }
